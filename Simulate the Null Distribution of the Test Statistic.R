...
#########################################
write.table(mc.circle.area.mat,"SimulatedTestStat.txt", row.names = FALSE, col.names = FALSE)
write.table(mc.prop.area.mat,"SimulatedProportion.txt", row.names = FALSE, col.names = FALSE)
